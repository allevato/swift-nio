...
extension _EmittingChannelHandler {
  @inlinable public func wrapOutboundOut(_ value: OutboundOut) -> NIOAny {
    return NIOAny(value)
  }
}
...
public protocol ChannelInboundHandler: _ChannelInboundHandler, _EmittingChannelHandler {
  ...
  @inlinable func unwrapInboundIn(_ value: NIOAny) -> InboundIn
  ...
  @inlinable func wrapInboundOut(_ value: InboundOut) -> NIOAny
}

/// Default implementations for `ChannelInboundHandler`.
extension ChannelInboundHandler {
  @inlinable public func unwrapInboundIn(_ value: NIOAny) -> InboundIn {
    return value.forceAs()
  }

  @inlinable public func wrapInboundOut(_ value: InboundOut) -> NIOAny {
    return NIOAny(value)
  }
}
...
extension ChannelOutboundHandler {
  @inlinable public func unwrapOutboundIn(_ value: NIOAny) -> OutboundIn {
    return value.forceAs()
  }
}
