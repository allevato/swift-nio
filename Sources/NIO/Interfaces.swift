...
extension ifaddrs {
  private var dstaddr: UnsafeMutablePointer<sockaddr>? {
    #if os(Linux)
  ...
  private var broadaddr: UnsafeMutablePointer<sockaddr>? {
    #if os(Linux)
...
extension NIONetworkInterface: Equatable {
  public static func == (lhs: NIONetworkInterface, rhs: NIONetworkInterface) -> Bool {
    return
      ...
      lhs.broadcastAddress == rhs.broadcastAddress && lhs.pointToPointDestinationAddress ==
