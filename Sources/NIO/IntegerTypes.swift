...
@usableFromInline struct _UInt24: ExpressibleByIntegerLiteral {
  @usableFromInline typealias IntegerLiteralType = UInt16
  ...
  @usableFromInline init(integerLiteral value: UInt16) {
...
extension _UInt56 {
  init(_ value: UInt64) {
    ...
    self.init(
      b1234: UInt32(truncatingIfNeeded: (value & 0xff_ff_ff_ff) >> 0),
